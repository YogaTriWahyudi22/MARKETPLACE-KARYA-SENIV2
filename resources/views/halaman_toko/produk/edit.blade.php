    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('produk_edit', $edit->id_produk) }}" method="POST"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="satuan" value="{{ $edit->satuan }}" class="form-control"
                                placeholder="Input Satuan Produk" required>
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Deskripsi</label><br>
                            <textarea name="deskripsi" id="" cols="30" class="form-control" rows="10"
                                placeholder="Input Deskripsi" required>{{ $edit->nama_produk }}</textarea>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" name="jenis_karya_seni" aria-label="Default select example">
                                <option selected>{{ $edit_produk->jenis_karya_seni }}</option>
                                @foreach ($edit_jenis as $jenis)
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="jumlah_produk" value="{{ $edit->jumlah_produk }}"
                                class="form-control" placeholder="Input Jumlah Produk" required>
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Harga</label><br>
                            <input type="number" name="harga" class="form-control" value="{{ $edit->harga }}"
                                placeholder="Input Jumlah harga" required>
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Diskon</label><br>
                            <input type="number" name="diskon" class="form-control" value="{{ $edit->diskon }}"
                                placeholder="Input Jumlah diskon" required>
                        </div>
